...
internal static class Program
{
    ...
    {
        string original = "The Lord of the Rings, J.R.R. Tolkien";
        string q = "j.r r";

        SearchIndex[] indices = Utils.FuzzySearchDetailed(original, q);
        Console.WriteLine(string.Join(", ", indices));
        WriteHighlighted(original, indices);
        Console.WriteLine(Utils.FuzzySearchRating(original, q));
        Console.WriteLine(Utils.FuzzySearch(original, q));
